...
const topLinks = computed<SideBarLink[]>(() => [
  ...
  },
  {
    ...
    title: i18n.t("fmp.title"),
    restricted: true,
    children: [
      {
        icon: $globals.icons.database,
        title: i18n.t("fmp.inventory.title"),
        to: "/household/fmp/inventory",
        restricted: true,
      },
      {
        icon: $globals.icons.group,
        title: i18n.t("fmp.people.title"),
        to: "/household/fmp/people",
        restricted: true,
      },
      {
        icon: $globals.icons.chart,
        title: i18n.t("fmp.planner.title"),
        to: "/household/fmp/planner",
        restricted: true,
      },
    ],
  },
